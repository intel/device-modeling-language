...
This approach extends to any number of conflicting templates &mdash; as long as
...
conflicting implementation in turn &mdash; if that doesn't cause side-effects
to be duplicated in an undesirable way &mdash; or even only call one particular
implementation &mdash; if it makes sense to prefer it ahead of every other.
